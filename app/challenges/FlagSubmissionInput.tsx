...
export default function FlagSubmissionInput(props: FlagSubmissionInputProps) {
    ...
    return (
        ...
        >
            <input
                type="text"
                className={'rounded-l px-3 py-2 border min-w-0 flex-grow placeholder:text-secondary focus:outline-none focus-visible:ring-[3px] transition duration-100 ' + (props.solved ? 'bg-success/10 border-success ring-success/30' : 'bg-black/30 border-primary')}
